...
!function ($) {
    ...
    var Validator = function ( options ) {
        ...
        this.messages = {
            ...
            , regexp:         "This value seems to be invalid 222."
    ...
    Validator.prototype = {
        ...
        */
        ...
        , formatMesssage: function ( message, args ) {
            console.log('formatMesssage:', message, args )

            if ( 'object' === typeof args ) {
                for ( var i in args ) {
                    message = this.formatMesssage( message, args[ i ] );
                }
                console.log('formatMesssage message:', message )

                return message;
            }
            console.log('messsage string:', typeof message )
            console.log('messsage args:', args )
        ...
        , addMessage: function ( key, message, type ) {
            console.log('addMessage','key:',key )
    ...
    ParsleyField.prototype = {
        ...
        , manageError: function ( constraint ) {
            console.log('manageError constraint:', constraint)
